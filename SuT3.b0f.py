...
while not done:
    ...
    if keys[pygame.K_d]:
        gd['px'] += 3
        if gd['px'] > (screen_width - 20):
            gd['px'] = (screen_width - 20)
    
    #--
    pygame.display.set_caption("SuT3")
    # --- Game logic
    main_dialog.update()
    for oi in Lxc:
        exec(oi)
    ...
    for bullet in bullet_list:
        ...
        #hit_baLL0_list = pygame.sprite.spritecollide(baLL0, bullet_list, False)
